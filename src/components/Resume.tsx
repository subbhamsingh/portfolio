  ...
  return (
    <section id="resume" className="bg-gradient-to-b from-[#2d0b46] to-[#11001c] py-20 text-white text-center">
      ...
      <div className="mb-8">
        ...
        <iframe
          src="https://drive.google.com/file/d/19xqrEt7V_3tJwi1dakHIqh55SYIx0lNH/preview"
          width="640"
          height="360"
          allow="autoplay"
      ...
      <div>
        ...
        <iframe
          src="https://drive.google.com/file/d/1Y4j0ecGEzUt2y8h1BRDRlklvLLKKS6Dz/preview"
          width="640"
          height="360"
          allow="autoplay"
          className="w-full max-w-lg mx-auto"
